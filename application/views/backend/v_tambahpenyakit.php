        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="<?= base_url('admin/Penyakit/tambah_aksi') ?>" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    <label>Kode</label>
                    <input type="text" name="kode" class="form-control" value="<?= $cekkode ?>" disabled>
                  </div>
                  <div class="form-group">
                    <label>Nama Penyakit atau Penyakit</label>
                  ...
                  <div class="form-group">
                    <label>Detail</label>
                    <textarea type="text" name="detail_penyakit" class="form-control" required></textarea>
                    <?= form_error('detail_penyakit', '<div class="text-small text-danger">', '</div>'); ?>
                  </div>
                  <div class="form-group">
                    <label>Penanganan</label>
                    <textarea type="text" name="penanganan_penyakit" class="form-control" required></textarea>
                  ...
                  <div class="form-group">
                    ...
                    <select name="kategori" id="kategori" class="form-control" required>
                      ...
                      <option class="text-center" value="Hama">Hama</option>
                      <option class="text-center" value="Penyakit">Penyakit</option>
                    </select>
                  </div>
                  <div class="form-group">
                    <label>Foto</label>
